...
import type { CompletedConfig, Config } from '../src/Config'
import type { FormatterAugmentor } from '../src/factory/formatter'
import type { ParserAugmentor } from '../src/factory/parser'
...
import { createFormatter } from '../src/factory/formatter'
import { createGenerator } from '../src/factory/generator'
import { createParser } from '../src/factory/parser'
import { createProgram } from '../src/factory/program'
...
export function assertConfigSchema(
  ...
  return async () => {
    ...
    if (config.markdownDescription)
      keywords.push('markdownDescription')
    if (config.fullDescription)
      keywords.push('fullDescription')
